...
![JIT performance as of 17 March (PST)]({{ site.baseurl }}/media/brrr-20260318.png)
...
I'm going to cover a lesser talked about part of a JIT: the people, and a bit of luck. If you want the technical details of how we did it, it's [here]({{ site.baseurl }}/posts/faster-jit-plan.html) 
